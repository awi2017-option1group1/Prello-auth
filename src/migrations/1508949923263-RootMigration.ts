...
export class RootMigration1508949923263 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."user" DROP "lastname"`);
        await queryRunner.query(`ALTER TABLE "public"."user" DROP "firstname"`);
        await queryRunner.query(`ALTER TABLE "public"."user" DROP "biography"`);
        await queryRunner.query(`ALTER TABLE "public"."user" DROP "notificationsEnabled"`);
        await queryRunner.query(`ALTER TABLE "public"."user" ADD "uuid" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        await queryRunner.query(`ALTER TABLE "public"."user" DROP CONSTRAINT "uk_user_pseudo"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`-- TODO: revert ALTER TABLE "public"."user" DROP CONSTRAINT "uk_user_pseudo"`);
        await queryRunner.query(`ALTER TABLE "public"."user" DROP "uuid"`);
        await queryRunner.query(`ALTER TABLE "public"."user" ADD "notificationsEnabled" boolean NOT NULL`);
        await queryRunner.query(`ALTER TABLE "public"."user" ADD "biography" text`);
        await queryRunner.query(`ALTER TABLE "public"."user" ADD "firstname" character varying`);
        await queryRunner.query(`ALTER TABLE "public"."user" ADD "lastname" character varying`);
