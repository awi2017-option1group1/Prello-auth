...
ALTER TABLE "public"."user" ADD "token" character varying DEFAULT NULL;
...
INSERT INTO "client" ("client_id", "name", "redirect_uris", "is_trusted") VALUES ('9fc19d15-4a3a-4373-8f50-c1b478a8051b', 'Prello-Zendesk', 'http://localhost/redirect', false);
